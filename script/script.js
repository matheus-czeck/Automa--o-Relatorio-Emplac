...
const data_input = document.querySelector("#date")
const placa_input = document.querySelector("#place")
...
btn_gerar.addEventListener("click", ()=>{
    ...
    for(i = firstNumber.value ; i <= lastNumber.value ; i++){
